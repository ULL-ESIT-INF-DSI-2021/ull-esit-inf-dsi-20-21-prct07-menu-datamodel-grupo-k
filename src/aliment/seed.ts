...
class Seed extends Aliment{
    ...
    printAliment(): string{
        let aliment_aux = new Seed(this.getNameAliment(), this.getPriceOfAliment(), this.getProtein(), this.getFats(), this.getCarbohydrates(), this.getCalories(), this.getStarch(), this.getSugars(), this.getFiber(), this.getWater(), this.getLocality(), this.getCity());
