...
/**
 * clase que representa a la categoria de un alimento. En este caso representa a carnes de pescado.
 */
export class Fish extends Aliment {
    /**
   * atributo del tipo gupo de alimentos
   * para identificar que es un alimento de tipo Fish
   */
