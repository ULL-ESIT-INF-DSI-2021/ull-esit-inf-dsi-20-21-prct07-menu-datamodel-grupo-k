...
/**
 * clase que representa a la categoria de un alimento. En este caso representa a lops cereales.
 */

export class Cereal extends Aliment {
  /**
   * atributo del tipo gupo de alimentos
   * para identificar que es de tipo cereal
   */
